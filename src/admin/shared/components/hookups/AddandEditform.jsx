        ...
        return (
            <div>
                ...
                <input 
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent" 
                    onChange={handlechange}
                    placeholder={`Enter ${getFieldLabel(activeTab).toLowerCase()}`}
                    required
                />
            </div>
        );
            ...
            >
                <form onSubmit={!formdata._id ? handlesave : handleupdate}>
                    ...
                    <div className="flex justify-end gap-4 mt-8">
                        <button 
                            type="button" 
                            className="px-6 py-3 text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition-colors" 
                        ...
                        <button 
                            type="submit" 
                            className="px-8 py-3 text-white bg-black hover:bg-gray-800 transition-colors"
                        >

...
export default function AddandEditform ({ visible, setVisible, file,productname, handlesave,desktopFile, mobileFile, handlechange, loading, formdata, handleupdate }) {
                  ...
                  <div className='mb-3'>
                        ...
                        <div className='flex items-center justify-center mb-3'>
                            <div className='mr-4'>
                                ...
                                <label className="flex flex-col items-center overflow-hidden justify-center h-40 w-40 object-cover border-2 border-gray-300 border-dashed cursor-pointer bg-gray-50">
                                    {desktopFile ? (
                                        <img src={desktopFile} className='h-full w-full object-cover' alt="Desktop" />
                                    ) : (
                                        <>
                                    ...
                                    <input type="file" name="DesktopImage" onChange={handlechange} className="hidden" accept="image/*" />
                                </label>
                            </div>
                            ...
                            <div>
                                ...
                                <label className="flex flex-col items-center overflow-hidden justify-center h-40 w-40 object-cover border-2 border-gray-300 border-dashed cursor-pointer bg-gray-50">
                                    {mobileFile ? (
                                        <img src={mobileFile} className='h-full w-full object-cover' alt="Mobile" />
                                    ) : (
                                        <>
                                            <div className="flex flex-col items-center justify-center pt-4 pb-5">
                                    ...
                                    <input type="file" name="MobileImage" onChange={handlechange} className="hidden" accept="image/*" />
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 gap-3 lg:grid-cols-2'>
                        ...
                        <div className="mb-2">
                            ...
                            <select name="select_type" value={formdata?.select_type || ''} onChange={handlechange} className="w-full px-4 py-2 border rounded-md outline-none">
                                <option value="">Select Type</option>
                                <option value="redirect_link">Redirect Link</option>
                                <option value="select_products">Select Products</option>
                            </select>
                        </div>
                        {formdata?.select_type === "redirect_link" && (
                            <div className="mb-2">
                                <div className="mb-2">
                        ...
                        {formdata?.select_type === "select_products" && (
                            <div className="mb-2">
                                <div className="mb-2">

export default function Tableheadpanel ({setGlobalFilter}) {

    return (
        <>
          <div className="flex flex-col md:items-center md:justify-between md:flex-row mb-3">
                <div><h2 className="mb-2 text-2xl font-bold md:mb-0">Orders</h2></div>
                <div className="flex items-center gap-4">
                    <div className="relative min-w-64 md:min-w-80">
                        ...
                        <input onChange={(e) => setGlobalFilter(e.target.value)} type="text" id="icon" name="icon" className="block w-full px-4 py-3 text-sm border border-gray-200 outline-none ps-11 disabled:opacity-50 disabled:pointer-events-none" placeholder="Search orders ..." />
                    </div>
                </div>
            </div>
        </>

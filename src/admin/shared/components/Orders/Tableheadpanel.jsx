          ...
          <div className="flex flex-col md:items-center md:justify-between md:flex-row mb-3">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative min-w-64 md:min-w-80 flex items-center">
                        ...
                        <input onChange={(e) => setGlobalFilter(e.target.value)} value={globalFilter} type="text" id="icon" name="icon" className="block w-full px-4 py-3 text-sm border border-gray-200 outline-none ps-11 disabled:opacity-50 disabled:pointer-events-none" placeholder="Search Orders ..." />

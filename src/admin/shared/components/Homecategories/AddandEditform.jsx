...
export default function AddandEditform({ visible, setVisible, file, handlesave, handlechange, loading, formdata, handleupdate }) {
    


    return (
        <>
            <Dialog header="Category Details" visible={visible} onHide={() => setVisible(false)} className="!w-full lg:!w-[40rem]">
                <form onSubmit={!formdata?._id ? handlesave : handleupdate}>
                    ...
                    <div className='grid grid-cols-1 gap-3 lg:grid-cols-2'>
                        ...
                        <div className="mb-2">
                            ...
                            <input type="text" name="redirect_link" value={formdata?.redirect_link || ''} onChange={handlechange} className="w-full px-4 py-2 border rounded-md outline-none" required/>                            
                        </div>

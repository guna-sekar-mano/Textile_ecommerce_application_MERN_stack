        ...
        return (
            <div className="flex gap-3">
                <div title="Edit Details">
                    <i className="fi fi-sr-pen-circle text-xl text-green-500 cursor-pointer" 
                       onClick={() => editfrom(rowData)}></i>
                </div>
                <div title="Delete this record">
                    <i className="fi fi-sr-trash text-xl text-red-500 cursor-pointer" 
            ...
            <div className="max-w-xs">
                {productNames.length <= 2 ? (
                    ...
                    <div>
                        ...
                        <span className="text-blue-500 cursor-pointer ml-1" title={productNames.join(', ')}>

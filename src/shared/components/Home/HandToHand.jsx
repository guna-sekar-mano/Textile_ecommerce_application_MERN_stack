    ...
    return (
        <>
            <section className="bg-[url('/images/hand-to-hand.jpg')] lg:h-screen bg-no-repeat w-full bg-cover bg-center bg-fixed">
                <div className="bg-black/40 lg:h-screen h-full">
                    <div className=" max-w-[95rem] mx-auto px-3">
                        <div className="flex lg:block gap-4">
                            <h1 className="lg:text-7xl text-5xl text-white pt-8 font-bold barlow-condensed">HAND</h1>
                            <h1 className="lg:text-7xl text-5xl text-white font-bold lg:mx-52 pt-8 barlow-condensed">TO</h1>
                            <h1 className="lg:text-7xl text-5xl text-white font-bold pt-8 lg:mx-[20%] barlow-condensed">HAND</h1>
                        </div>
                        <hr className="text-white/35 mt-5 lg:mt-10" />
                        <div className="flex lg:justify-end justify-center py-5 lg:py-10">
                            <div className="lg:w-1/2 text-justify space-y-5 lg:space-y-8 lg:text-base">

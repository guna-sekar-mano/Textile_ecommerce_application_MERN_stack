export default function TermsandConditions () {
    ...
    return (
        <>
        <section className="py-10 max-w-[75rem] mx-auto">
            <div className="text-center font-handelgothic text-2xl">
                <h2>Terms and Conditions</h2>
            </div>

            <div className="my-5">
                    <p className="text-lg text-justify">At Extreme Culture, we value your privacy and are committed to protecting your personal information. This Privacy Policy outlines the
                    ...
                    <ol className="space-y-1">
                        <li>Email :extremeculture@gmail.com</li>
                        <li>Mobile :987456123</li>
                        <li>Address :Chennai - 600028</li>
                    </ol>
                </div>
